...
const IF2_MS_PROPERTIES_OS_DESCRIPTOR: [u8; 142] = [
    ...
    b'{',0, b'C',0, b'D',0, b'B',0, b'3',0, b'B',0, b'5',0, b'A',0,
    b'D',0, b'-',0, b'2',0, b'9',0, b'3',0, b'B',0, b'-',0, b'4',0,
    b'6',0, b'6',0, b'3',0, b'-',0, b'A',0, b'A',0, b'3',0, b'6',0,
    b'-',0, b'1',0, b'A',0, b'A',0, b'E',0, b'4',0, b'6',0, b'4',0,
    b'6',0, b'3',0, b'7',0, b'7',0, b'6',0, b'}',0, 0,0
];
            ...
            match OSFeatureDescriptorType::try_from(req.index) {
                ...
                Ok(OSFeatureDescriptorType::Properties) => {
                    ...
                    match req.value as u8 {
                        2 => {
                            xfer.accept_with_static(&IF2_MS_PROPERTIES_OS_DESCRIPTOR).ok();
                        },
                        _ => {
                            xfer.reject().ok();
                        },
